...
ตอน agent เรียก tool ที่ต้องการ approval (Bash, Edit, Write —
ดู[บทที่ 5](ch05-permissions.md)) และมี session มือถือ/เบราว์เซอร์
active อยู่ approval prompt จะ route ตาม surface ที่เปิดอยู่:

- **browser chat เปิดอยู่:** modal โผล่ขึ้นมาพร้อมชื่อ tool,
  preview argument เต็ม ๆ, และปุ่ม **[Approve] [Deny]** modal
  Approval บน desktop sync ตามทันที — approve ที่ surface ไหน
  ก็ปิดทั้งสอง
- **browser chat ไม่เปิด:** fall back ไปที่ LINE OA Quick Reply
  bot push bubble หน้าตาแบบนี้:
...
- **ไม่เปิดทั้งคู่:** modal Approval บน desktop ทำงานปกติ
  routing มือถือ/เบราว์เซอร์เป็นเพิ่มเติม ไม่ใช่แทนที่
